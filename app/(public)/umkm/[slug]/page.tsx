...
import { MapPin, Phone, Globe, Map, Store, ShoppingBag } from 'lucide-react';
...
export default async function UMKMDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const waLink = umkm.whatsapp ? `https://wa.me/${formatWA(umkm.whatsapp)}` : null;
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative -mt-16 sm:-mt-24 mb-12 flex flex-col sm:flex-row gap-6 sm:items-end">
              ...
              <div className="flex flex-wrap gap-2">
                {waLink && (
                  <a href={waLink} target="_blank" rel="noopener noreferrer">
                    <Button className="bg-[#25D366] hover:bg-[#1ebd5a] text-white">
