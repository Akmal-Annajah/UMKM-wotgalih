  ...
  return (
    <div className="flex flex-col gap-24 pb-24">
      ...
      <section className="relative overflow-hidden bg-slate-900 pt-24 pb-32 text-white sm:pt-32 sm:pb-40">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            <Link href="/umkm">
              <Button size="lg" className="w-full sm:w-auto h-14 px-8 rounded-full bg-blue-600 hover:bg-blue-700 text-white text-base font-semibold shadow-xl shadow-blue-500/25 transition-all hover:-translate-y-1 border-0">
                Jelajahi UMKM
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="#tentang">
              <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 px-8 rounded-full border-slate-600 bg-slate-800/50 hover:bg-slate-800 text-white text-base font-semibold backdrop-blur-sm transition-all hover:-translate-y-1">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6">
            {categories.map((cat) => (
              <Link key={cat.id} href={`/umkm?category=${cat.slug}`}>
                <Card className="group cursor-pointer hover:border-blue-500 hover:shadow-lg transition-all duration-300 bg-white rounded-3xl border-slate-200">
                  <CardContent className="flex flex-col items-center justify-center p-6 sm:p-8">
                    <div className="mb-4 rounded-full bg-blue-50 p-4 text-blue-600 group-hover:-translate-y-1 group-hover:bg-blue-100 transition-transform duration-300">
      ...
      <section id="tentang" className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-blue-900 text-white overflow-hidden relative shadow-2xl">
          <div className="absolute top-0 right-0 p-32 bg-blue-500/20 blur-3xl rounded-full translate-x-1/2 -translate-y-1/2" />
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center p-8 sm:p-16">
            ...
            <div className="hidden lg:block relative aspect-video rounded-2xl overflow-hidden bg-blue-800 border border-blue-700 shadow-xl">
              <div className="absolute inset-0 flex items-center justify-center text-blue-600/50">
