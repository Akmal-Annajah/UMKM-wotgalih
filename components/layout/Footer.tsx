        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/umkm" className="hover:text-emerald-400 transition-colors">Daftar UMKM</a></li>
              <li><a href="/login" className="hover:text-emerald-400 transition-colors">Login UMKM</a></li>
            </ul>
          </div>
          <div>
